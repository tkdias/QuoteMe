<?php
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        $list .= "<td>" . $row['city']. "</td>";
        $list .= "<td>" . $row['province']. "</td>";
        $list .= "<td>" . $row['traffic']. "</td>";
        $list .= "</tr>";
      }
...
<head>
  ...
  <title>Smart EE Checkup | Patient - Portal Live Traffic</title>
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      <h1>
			 View Portal Live Traffic Information
        <small><!-- --></small>
      </h1>
      <ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>Portal Management</a></li>
        <li><a href="#">View Portal Live Traffic Information</a></li>
      </ol>
    </section>
