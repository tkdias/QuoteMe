<?php
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        $list .= "<td>" . $row['hospital']. "</td>";
        $list .= "<td>" . $row['mapurl']. "</td>";
        $list .= "<td>" . $row['city']. "</td>";
        $list .= "<td>" . date('Y-m-d', strtotime($row['JoinDate'])) . "</td>";
        $list .= "<td>" . "<a href = 'portal_table.php?delete=$id'><button type='button' class='btn btn-danger'>Delete</button></a>"."</td>";
        $list .= "</tr>";
      }
...
<head>
  ...
  <title>Smart EE Checkup | Admin - Portal Update</title>
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">View Portal Information</a></li>
      </ol>
    </section>
