<?php
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        $list .= "<td>" . $status . "</td>";
        $list .= "<td>" . "<a href = 'admin_patient_list-approved.php?delete=$id'><button type='button' class='btn btn-danger'>Delete</button></a>"."</td>";
        $list .= "</tr>";
      }
      ...
      if (isset($_GET['delete'])) {
       ...
       if ($result) {
          echo "<script>window.open('admin_patient_list-approved.php','_self')</script>";
      }
...
<head>
  ...
  <title>Smart EE Checkup | Admin - Patient Profile mgm</title>
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      <h1>
			Patient Information Management - Approved
        <small><!-- --></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Patients profile Mgm</a></li>
        <li><a href="#">Approved Patient Information</a></li>
      </ol>
    </section>
