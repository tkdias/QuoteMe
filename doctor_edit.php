          ...
          //Image Data
        	...
        	$file_ext = substr($file_name, strripos($file_name, '.')); // file extention
					...
					if($_POST['d_password'] == $_POST['d_cpassword']){
						$hashed_password = sha1($_POST['d_password']);
						$sql = "UPDATE doctors SET address='".$_POST['d_address']."',city='".$_POST['d_city']."',province='".$_POST['d_province']."',mobile='".$_POST['d_mobile']."',password='$hashed_password', image='$newfilename' WHERE doctorID='$var_value'";

          }
          else{
						$error[] = 'Password not matched';
						$sql = "UPDATE doctors SET address='".$_POST['d_address']."',city='".$_POST['d_city']."',province='".$_POST['d_province']."',mobile='".$_POST['d_mobile']."',password='$hashed_password' WHERE doctorID='$var_value'";
					}
...
<head>
  ...
  <title>Smart EE Checkup | Doctors Profile Update</title>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <form enctype="multipart/form-data" method="post" accept-charset="utf-8" class="validateForm form-horizontal" action"doctor_edit.php">
    

		<?php
	
		include_once "dbconnect.php";
        $result = mysqli_query($conn,"SELECT * FROM doctors WHERE doctorID='$var_value'");
    ...
    <!------------------------------------------------------------------- Fieldset 1 - Personal Information ------------------------------ -->
				<br><fieldset>
					...
					<div class="form-group">
					  ...
					  <label class="control-label col-md-2" for="email">Doctor ID<span class="text-danger"> *</span></label>
					  <div class="col-md-6">
						<div class="input text">
						  <input type="text" name="d_doctorID" class="form-control"  id="" value="<?php echo $row ['doctorID']; ?>" disabled>
						</div>
					  </div>
					</div>
					...
					<div class="form-group">
					  ...
					  <div class="col-md-6">
						<div class="input text">
						  <input type="text" name="d_first_name" class="form-control validate[required]" id="" value="<?php echo $row ['first_name']; ?>" disabled>
						</div>
					  </div>
					</div>
				  ...
				  <div class="form-group">
					...
					<div class="col-md-6">
					  <div class="input text">
						<input type="text" name="d_last_name" class="form-control validate[required]" id="" value="<?php echo $row ['last_name']; ?>" disabled>
					  </div>
					</div>
				  </div>
					...
					<div class="col-md-6 checkbox">
					  <input type="hidden" name="d_gender" value="" disabled>
					  <label for="gender-male">
				<input type="radio" name="d_gender" value="male" id="gender-male" <?php if($row ['gender']=="male"){ ?>checked="checked"<?php }?>>Male
					  </label>
					  <label for="gender-female">
						<input type="radio" name="d_gender" value="female" id="gender-female" <?php if($row ['gender']=="female"){ ?>checked="checked"<?php }?>>Female
					  </label>
					</div>
				  </div>
					...
					<div class="form-group">
						<label class="control-label col-md-2" for="email">Date of Birth<span class="text-danger"> *</span></label>
							...
							<div class="input-group">
							  ...
							  <input type="text" name="d_dob" class="form-control"  value="<?php echo $row['dob']?>"  data-inputmask="'alias': 'yyyy-mm-dd'"  data-mask disabled>
							</div>
					...
					<div class="col-md-6">
					  <div class="input text">
						<input type="text" name="d_nic" class="form-control validate[required]" id="" value="<?php echo $row ['nic']; ?>" disabled>
					  </div>
					</div>
				  </div>

					<div class="form-group">
					<label class="control-label col-md-2" for="email">DRN Number<span class="text-danger"> *</span></label>
					<div class="col-md-6">
					  <div class="input text">
						<input type="text" name="d_regno" class="form-control validate[required]" id="" value="<?php echo $row ['regno']; ?>" disabled>
					  </div>
					</div>
				  </div>
				...
				<fieldset>
					...
					<legend>Contact Information</legend>
					  ...
					  <div class="form-group">
						...
						<div class="col-md-6">
						  <div class="input text">
							<input type="text" name="d_address" class="form-control validate[required]" id="" value="<?php echo $row ['address']; ?>">
						  </div>
						</div>
					  </div>
					  ...
					  <div class="form-group">
						<label class="control-label col-md-2" for="email">City<span class="text-danger"> *</span></label>
						  <div class="col-md-6">
							<div class="input text">
							  <input type="text" name="d_city" class="form-control validate[required]" id="" value="<?php echo $row ['city']; ?>">
							</div>
						  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-md-6">
							<div class="input text">
							  <input type="text" name="d_province" class="form-control" id="" value="<?php echo $row ['province']; ?>">
							</div>
						  </div>
						</div>
						  ...
						  <div class="col-md-6">
							<div class="input-group">
								<div class="input-group">
									...
									<input type="text" name="d_mobile" class="form-control" data-inputmask='"mask": "(99) 999-9999"' data-mask id="" value="<?php echo $row ['mobile']; ?>" placeholder="7x xxx xxxx">
								</div>
							</div>
						  </div>
						</div>
	...
	<fieldset>
				...
				<div class="col-md-6">
					<div class="input text">
					<input type="text" name="d_email" class="form-control validate[required]" id="" value="<?php echo $row ['email']; ?>" disabled>
					</div>
				</div>
				</div>
