...
if (isset($_POST['signin'])) {
    ...
    if (empty($error)) {
        ...
        $query = "SELECT * FROM patients WHERE email ='$email' AND password = '$hashed_password' AND status='1'";
...
<head>
  ...
  <title>Smart EE Checkup | Patient Sign In</title>
    ...
    <form action="login_p.php" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          ...
          <button type="submit" name="signin" class="btn btn-block btn bg-navy btn-flat">Sign In</button>
...
<!--*******************************************************************-->
    ...
    <a href="signup_p.php" class="text-center">Register a new membership</a> | <a href="section.php" class="text-center"><b>Back</b></a>
    </div>
