<?php
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        $list .= "<tr>";
        $list .= "<td>" . $row['adminID']. "</td>";
        $list .= "<td>" . $row['first_name']. "</td>";
        $list .= "<td>" . $row['nic']. "</td>";
        $list .= "<td>" . $row['mobile']. "</td>";
        $list .= "<td>" . date('Y-m-d', strtotime($row['JoinDate'])) . "</td>";
        $list .= "<td>" . "<a href='admin_edit.php?edit=$id'><button type='button' class='btn btn-success'>Edit</button></a>" ."&nbsp;". "<a href = 'admin_table.php?delete=$id'><button type='button' class='btn btn-danger'>Delete</button></a>"."</td>";
        $list .= "</tr>";
      }
