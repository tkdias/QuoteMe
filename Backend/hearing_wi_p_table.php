<?php
      ...
      $query = "SELECT * FROM htestwi WHERE patientID='$var_value'";
...
//------------------------------------------
        ...
        $list .= "<td>" . $hearing_1 . "</td>";
        $list .= "<td>" . $hearing_2 . "</td>";
        $list .= "<td>" . $hearing_3 . "</td>";
        $list .= "<td>" . $hearing_4 . "</td>";
        $list .= "<td>" . $hearing_5 . "</td>";
        $list .= "</tr>";
      }
      ...
      // create database query
			$query = "DELETE FROM htestft WHERE testID = '$id'";
...
<head>
  ...
  <title>Smart EE Checkup | Hearing - Word Identification test</title>
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      <h1>
			 View Hearing - Word Identification Information
        <small><!-- --></small>
      </h1>
      <ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>Hearing Checkup</a></li>
        <li><a href="#">Word Identification Test</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
		   ...
		   <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Read steps are taking as taking as result</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
