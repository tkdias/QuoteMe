        ...
        //$status = "1";
          ...
          VALUES ('".$_POST["patientID"]."','".$_POST["nic"]."','$randnum')";
            ...
            mail('tkdias7@gmail.com', $subject, $message, $from);
						...
						echo "<script>alert('New RFID request failed')</script>";
					}
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">New RFID Registration</a></li>
      </ol>
    </section>
    ...
    <!------------------------------------------------------------------- Fieldset 1 - Personal Information ------------------------------ -->
				<br><fieldset>
					...
					<div class="form-group">
					  ...
					  <div class="col-md-6">
						<div class="input text">
						  <input type="text" name="nic" class="form-control validate[required]" id="" value="<?php echo $nicno; ?>">         
						</div>
					  </div>
					</div>
