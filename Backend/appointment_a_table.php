<?php
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        $list .= "<tr>";
        $list .= "<td>" . $row['appointmentID']. "</td>";
        $list .= "<td>" . $row['patientID']. "</td>";
        $list .= "<td>" . $row['portalID']. "</td>";
        $list .= "<td>" . $row['checkuptype']. "</td>";
        $list .= "<td>" . $row['appointmentDate']. "</td>";
        $list .= "<td>" . $row['appointmentTime']. "</td>";
        $list .= "<td>" . "<a href = 'appointment_a_table.php?delete=$id'><button type='button' class='btn btn-danger'>Delete</button></a>"."</td>";
        $list .= "</tr>";
      }
      ...
      if ($result) {
          ...
          echo "<script>window.open('appointment_a_table.php','_self')</script>";
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">View Appointment Information</a></li>
      </ol>
    </section>
