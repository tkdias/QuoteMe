<?php
      ...
      // create database query
			$query = "DELETE FROM vtestsd WHERE testID = '$id'";
...
<head>
  ...
  <title>Smart EE Checkup | Vision - Short Distance</title>
...
<!-- end: CSS & Font -->
    ...
    <?php
include "component-header_d.php";
?> <!-- ----------------------------- ( Header Section ) -------------------------------- -->
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
             View Short Distance Vision Information
        <small><!-- --></small>
      </h1>
      <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Vision Checkup</a></li>
        <li><a href="#">Short Distance test</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
           ...
           <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Vision is taking as 5 Font sizes. ( 5 words per line x 5 lines ) </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<!-- ./wrapper -->
    ...
    <?php
include "component-sidebar-left_d.php";
?>
   <?php
include "component-footer_d.php";
?>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
		   ...
		   <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Vision is taking as 5 Font sizes. ( 15 words per line x 5lines ) </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
