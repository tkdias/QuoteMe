<?php
      ...
      $query = "SELECT * FROM htestft WHERE patientID='$var_value'";
...
<head>
  ...
  <title>Smart EE Checkup | Hearing - Frequency test</title>
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      <h1>
			 View Hearing - Frequency test Information
        <small><!-- --></small>
      </h1>
      <ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>Hearing Checkup</a></li>
        <li><a href="#">Frequency Test</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
		   ...
		   <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Frequencies are taking as taking as Hz.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
