<?php
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        $list .= "<td>" . $status . "</td>";
        $list .= "<td>" . "<a href = 'admin_doctor_list-approved.php?delete=$id'><button type='button' class='btn btn-danger'>Delete</button></a>"."</td>";
        $list .= "</tr>";
      }
...
<head>
  ...
  <title>Smart EE Checkup | Admin - Doctor Profile mgm</title>
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      <h1>
      Doctors Information Management - Approved
        <small><!-- --></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Doctors profile Mgm</a></li>
        <li><a href="#">Approved Doctors Information</a></li>
      </ol>
    </section>
