<?php
      ...
      $query = "SELECT * FROM patients WHERE status= 2";
...
<head>
  ...
  <title>Smart EE Checkup | Critical Patient Profile mgm</title>
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      <h1>
			Critical Patient Informations
        <small><!-- --></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Critical Patient mgm</a></li>
        <li><a href="#">View Critical Patient Information</a></li>
      </ol>
    </section>
