<!-- Main Header -->
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="home_a.php" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>EECA</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">EE Checkup |<b> A</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                <?php echo $_SESSION['adminID']; echo" | "; echo $_SESSION['first_name']; echo" "; echo $_SESSION['last_name'];?>
                  <small>Admin since : <?php echo $_SESSION['JoinDate']; ?></small>
                </p>
              </li>
              <!-- Menu Body -->
