<?php
      ...
      $query = "SELECT * FROM vtestld WHERE patientID='$var_value'";
      ...
      // create database query
			$query = "DELETE FROM vtestld WHERE testID = '$id'";
...
<head>
  ...
  <title>Smart EE Checkup | Vision - Long Distance</title>
...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      <h1>
			 View Long Distance Vision Information
        <small><!-- --></small>
      </h1>
      <ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>Vision Checkup</a></li>
        <li><a href="#">Long Distance test</a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
		   ...
		   <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Vision is taking as 20/x</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
